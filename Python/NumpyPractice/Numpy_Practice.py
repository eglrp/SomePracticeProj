...
print("Start exectuting program...")
...
b = a[..., 1];   # 注意这里的起始index=0
print(b) 

c = a[1, ...];   # 注意这里的起始index=0
print(c)
...
print(np.char.add(['hello'],[' Spring'])) 
...
# a = np.array([1, 2, 3, 4, 5])
# np.save('E:/outfile.npy', a)
# b = np.load('E:/outfile.npy')
# print(b)


# np.savetxt('E:/outfile.txt', a)
# b = np.loadtxt('E:/outfile.txt')
# print(b)
