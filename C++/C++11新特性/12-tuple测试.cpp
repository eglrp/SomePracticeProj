 ...
 * Version: v-1.0
 *
 * Description: https://blog.csdn.net/fengbingchun/article/details/72835446
 */
...
int test_tuple_1() {
...

    {
        ...
        // std::ref(): https://www.jianshu.com/p/5b91c51bd856
...

    {
        ...
        std::cout << std::get<0>(foo) << "\n"; // 12
        fun(std::get<0>(foo)); // std::get<0>(foo) lvalue
        std::cout << std::get<0>(foo) << "\n"; // 15
    }
