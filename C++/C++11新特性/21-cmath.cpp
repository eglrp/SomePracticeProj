 ...
 * Version: v-1.0
 *
 * Description: https://www.jishux.com/p/d3fb9b16c1848726
 */
...
int test_cmath_classify() {
...

    {
        ...
        printf("isinf(0.0)       : %d
               ", std::isinf(0.0)); // 0
               //printf("isinf(1.0/0.0)   : %d", std::isinf(1.0 / 0.0));
               //printf("isinf(-1.0/0.0)  : %d", std::isinf(-1.0 / 0.0));
               //printf("isinf(sqrt(-1.0)): %d", std::isinf(std::sqrt(-1.0))); // 0
    }

    {
        // std::isnan: Returns whether x is a NaN (Not-A-Number) value.
        printf("isnan(0.0)       : %d", std::isnan(0.0)); // 0
        //printf("isnan(1.0/0.0)   : %d", std::isnan(1.0 / 0.0));
        //printf("isnan(-1.0/0.0)  : %d", std::isnan(-1.0 / 0.0));
        printf("isnan(sqrt(-1.0)): %d", std::isnan(std::sqrt(-1.0))); // 1
    }

    {
        ...
        printf("isnormal(1.0)    : %d
               ", std::isnormal(1.0)); // 1
               printf("isnormal(0.0)    : %d", std::isnormal(0.0)); // 0
               //printf("isnormal(1.0/0.0): %d", std::isnormal(1.0 / 0.0));
    }

    {
        ...
        printf("signbit(0.0)       : %d
               ", std::signbit(0.0)); // 0
               //printf("signbit(1.0/0.0)   : %d", std::signbit(1.0 / 0.0));
               //printf("signbit(-1.0/0.0)  : %d", std::signbit(-1.0 / 0.0));
               printf("signbit(sqrt(-1.0)): %d", std::signbit(std::sqrt(-1.0))); // 1
    }
