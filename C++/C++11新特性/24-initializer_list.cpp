 ...
 * Author: Neverland_LY
 * Date: 2018-11-17
 * ProjectName: initializer_list
 * Version: v-1.0
 *
 * Description: https://blog.csdn.net/fengbingchun/article/details/77938005
 */
...
void print_list(std::initializer_list<T> il) {
    for (const T *it = std::begin(il); it != std::end(il); ++it)
        std::cout << ' ' << *it;
    std::cout << '\n';
}
